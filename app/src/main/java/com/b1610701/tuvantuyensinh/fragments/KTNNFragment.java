...
public class KTNNFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.fragment_ktnn, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        txt_title.setText(Html.fromHtml(getResources().getString(R.string.title_ktnn)));
        txt_thongtinchung.setText(Html.fromHtml(getResources().getString(R.string.thongtinchung)));
        txt_noidung_thongtinchung.setText(Html.fromHtml(getResources().getString(R.string.thongtinchung_ktnn)));
        ...
        txt_noidung_gioithieu.setText(Html.fromHtml(getResources().getString(R.string.gioithieu_ktnn)));
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
        ...
        txt_noidung_vitrivieclam.setText(Html.fromHtml(getResources().getString(R.string.vitrivieclam_ktnn)));
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
        ...
        txt_noidung_noilamviec.setText(Html.fromHtml(getResources().getString(R.string.noilamviec_ktnn)));
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
        ...
        webView.loadUrl("https://www.youtube.com/embed/q7nGbeFjCp0");
