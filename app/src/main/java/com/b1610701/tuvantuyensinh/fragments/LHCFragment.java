...
public class LHCFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        txt_title.setText(Html.fromHtml(getResources().getString(R.string.title_lhc)));
        txt_thongtinchung.setText(Html.fromHtml(getResources().getString(R.string.thongtinchung)));
        txt_noidung_thongtinchung.setText(Html.fromHtml(getResources().getString(R.string.thongtinchung_lhc)));
        ...
        txt_noidung_gioithieu.setText(Html.fromHtml(getResources().getString(R.string.gioithieu_lhc)));
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
        ...
        txt_noidung_vitrivieclam.setText(Html.fromHtml(getResources().getString(R.string.vitrivieclam_lhc)));
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
        ...
        txt_noidung_noilamviec.setText(Html.fromHtml(getResources().getString(R.string.noilamviec_lhc)));
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
        ...
        webView.loadUrl("https://www.youtube.com/embed/tV5mLOLBvW4");
