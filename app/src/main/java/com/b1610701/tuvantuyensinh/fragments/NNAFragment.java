...
public class NNAFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.fragment_nna, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        txt_title.setText(Html.fromHtml(getResources().getString(R.string.title_nna)));
        txt_thongtinchung.setText(Html.fromHtml(getResources().getString(R.string.thongtinchung)));
        txt_noidung_thongtinchung.setText(Html.fromHtml(getResources().getString(R.string.thongtinchung_nna)));
        ...
        txt_noidung_gioithieu.setText(Html.fromHtml(getResources().getString(R.string.gioithieu_nna)));
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
        ...
        txt_noidung_vitrivieclam.setText(Html.fromHtml(getResources().getString(R.string.vitrivieclam_nna)));
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
        ...
        txt_noidung_noilamviec.setText(Html.fromHtml(getResources().getString(R.string.noilamviec_nna)));
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
        ...
        webView.loadUrl("https://www.youtube.com/embed/7a4SeYyB1XI");
